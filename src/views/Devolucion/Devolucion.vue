<template>
  <div class="text-center">
    <div v-if="usuario !== null">
      <h3 class="text-success mb-4 titulo-principal">Devoluciones</h3>
      <div class="contenedor-filtro mt-4">
        ...
        <div class="row" v-if="buscarPor !== 1">
          ...
          <div class="form-group col-md-12" v-if="buscarPor === 2">
            <button class="btn btn-success" @click="verdevoluciones()">
              Buscar
            </button>
          </div>
        </div>
          ...
          <div class="form-group col-md-6">
            ...
            <div class="input-buscar">
              <input
                ...
                type="text"
                v-model="buscar"
                @keypress.enter="verdevoluciones()"
              />
              <button class="btn btn-success" @click="verdevoluciones()">
                &#128269;
              </button>
      ...
      <TablaDevoluciones :devoluciones="devoluciones" />
    </div>
    <div v-else>
...
export default {
  components: { Mensaje, TablaDevoluciones },
  data() {
    return {
      devolucion: {},
      devoluciones: [],
      mensaje: { ver: false },
      condiciones: [
        { descripcion: "NÚMERO", valor: "d.codigo" },
        { descripcion: "OBSERVACIÓN", valor: "d.observacion" },
  ...
  methods: {
    ...
    verdevoluciones() {
      ...
      this.axios
        .post("devolucion_prestamo/buscarporcondicion", buscarPor)
        .then((respuesta) => {
          if (respuesta.status === 200) {
            this.devoluciones = respuesta.data;
          }
        });
    },
  },
