<template>
  <div class="text-center">
    <div v-if="usuario !== null">
      <h3 class="text-success mb-4 titulo-principal">Movimientos de la Caja Mayor</h3>
      <button
        type="button"
        class="btn btn-success"
        data-toggle="modal"
        data-target="#modalGuardarmovimientoCajaMayor"
      >
      ...
      <div class="contenedor-filtro mt-4">
        ...
        <div class="row" v-if="buscarPor !== 1">
          ...
          <div class="form-group col-md-12" v-if="buscarPor === 2">
            <button class="btn btn-success" @click="vermovimientoCajaMayor()">
              Buscar
            </button>
          </div>
        </div>
          ...
          <div class="form-group col-md-6">
            ...
            <div class="input-buscar">
              <input
                ...
                type="text"
                v-model="buscar"
                @keypress.enter="vermovimientoCajaMayor()"
                :disabled="usuario.rol_codigo === 2"
              />
              <button class="btn btn-success" @click="vermovimientoCajaMayor()">
                &#128269;
      ...
      <TablaMovimientosCajaMayor :movimientosCaja="movimientosCaja" />
    </div>
    <div v-else>
    ...
    <div
      class="modal fade"
      id="modalGuardarmovimientoCajaMayor"
      tabindex="-1"
      role="dialog"
      aria-labelledby="modalGuardarmovimientoCajaMayor"
      aria-hidden="true"
            ...
            <form @submit.prevent>
              <div class="form-group col-md-12">
                ...
                <select
                  ...
                  class="form-select form-control"
                  aria-label="Default select example"
                  v-model="movimientoCajaMayor.tipo"
                >
                  <option
                    :value="tipo.valor"
              ...
              <div class="form group">
                ...
                <textarea
                  ...
                  v-model="movimientoCajaMayor.concepto"
                  class="form-control"
                />
              </div>
              ...
              <div class="form-group mt-2">
                ...
                <input
                  type="number"
                  placeholder="Valor $"
                  v-model="movimientoCajaMayor.valor"
                  class="form-control"
                />
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6 mt-3">
                  <input
                    ...
                    value="Guardar"
                    @click="guardarmovimientoCajaMayor()"
                  />
                </div>
              </div>
            </form>
...
<script>
import TablaMovimientosCajaMayor from "@/components/MovimientosCajaMayor/TablaMovimientosCajaMayor";
import { mapGetters } from "vuex";
import Mensaje from "@/components/Mensaje.vue";
import MonedaUtil from "@/util/MonedaUtil";
export default {
  components: { Mensaje, TablaMovimientosCajaMayor },
  data() {
    return {
      movimientoCajaMayor: { tipo: 1 },
      movimientosCaja: [],
      mensaje: { ver: false },
      condiciones: [
  ...
  methods: {
    ...
    vermovimientoCajaMayor() {
      ...
      this.axios
        .post("movimiento_caja_mayor/buscarporcondicion", buscarPor)
        .then((respuesta) => {
    ...
    guardarmovimientoCajaMayor() {
      const movimientoCajaMayor = this.movimientoCajaMayor;
      movimientoCajaMayor.usuario_codigo = this.usuario.codigo;
      this.axios
        .post("movimiento_caja_mayor", movimientoCajaMayor)
        .then((respuesta) => {
          if (respuesta.status === 200) {
            this.$router.push('/movimiento_caja_mayor')
            //window.location.href = "/movimiento_caja_mayor";
            $("#modalGuardarmovimientoCajaMayor").modal("hide");
          }
        })
        .catch((error) => {
    ...
    async guardarmovimientoCajaMayor2() {
      const movimientoCajaMayor = this.movimientoCajaMayor;
      movimientoCajaMayor.usuario_codigo = this.usuario.codigo;
      try {
